...
class RxFlextagramTheme
{
    ...
    public static function getConfig()
    {
        ...
        self::$config = [
            ...
            'chzzk_online_style' => $layout_info->chzzk_online_style ? base64_encode($layout_info->chzzk_online_style) : "c3BhbiNicm9hZGNhc3Qtb24gewogICAgZGlzcGxheTogYmxvY2s7Cn0KCnNwYW4jYnJvYWRjYXN0LW9mZiB7CiAgICBkaXNwbGF5OiBub25lOwp9",
            'chzzk_offline_style' => $layout_info->chzzk_offline_style ? base64_encode($layout_info->chzzk_offline_style) : "bGkuYnJvYWRjYXN0IHsKICAgIGRpc3BsYXk6IG5vbmUgIWltcG9ydGFudDsKfQoKc3BhbiNicm9hZGNhc3Qtb24gewogICAgZGlzcGxheTogbm9uZSAhaW1wb3J0YW50Owp9CgpzcGFuI2Jyb2FkY2FzdC1vZmYgewogICAgZGlzcGxheTogbm9uZSAhaW1wb3J0YW50Owp9",
        ];
